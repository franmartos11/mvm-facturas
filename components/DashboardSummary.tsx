...
export default function DashboardSummary({ invoices, items }: DashboardSummaryProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      {/* Total Spent Card */}
      <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm relative overflow-hidden group hover:border-blue-200 dark:hover:border-blue-900 transition-colors">
        ...
        <div>
          <p className="text-sm font-medium text-slate-500 dark:text-zinc-400">Gasto Total Acumulado</p>
        ...
        <div className="mt-4 flex items-center text-xs text-green-600 bg-green-50 dark:bg-green-900/30 dark:text-green-400 w-fit px-2 py-1 rounded-full">
      ...
      {/* Invoices Count Card */}
      <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm relative overflow-hidden group hover:border-purple-200 dark:hover:border-purple-900 transition-colors">
        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
        ...
        <div>
          <p className="text-sm font-medium text-slate-500 dark:text-zinc-400">Facturas Procesadas</p>
      ...
      {/* Average Ticket Card */}
      <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm relative overflow-hidden group hover:border-amber-200 dark:hover:border-amber-900 transition-colors">
        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
        ...
        <div>
          <p className="text-sm font-medium text-slate-500 dark:text-zinc-400">Ticket Promedio</p>
          <p className="text-3xl font-bold text-slate-900 dark:text-zinc-100 mt-2">
