                ...
                <tr key={item.id} className="hover:bg-muted/40 transition-colors group">
                  <td className="px-6 py-3 font-medium text-foreground">
                    {isEditing ? (
                      <input 
                        type="text"
                        className="w-full bg-background border border-input rounded px-2 py-1 text-sm focus:ring-2 focus:ring-primary/20 outline-none"
                  ...
                  <td className="px-6 py-3 text-right text-muted-foreground font-mono">
                     {isEditing ? (
                      <input 
                        type="number"
                        className="w-16 text-right bg-background border border-input rounded px-2 py-1 text-sm focus:ring-2 focus:ring-primary/20 outline-none"
                  ...
                  <td className="px-6 py-3 text-right text-muted-foreground font-mono">
                     {isEditing ? (
                      <input 
                        type="number"
                        step="0.01"
                        className="w-24 text-right bg-background border border-input rounded px-2 py-1 text-sm focus:ring-2 focus:ring-primary/20 outline-none"
                  ...
                  <td className="px-4 py-3 text-right">
                     {isEditing ? (
                       <div className="flex items-center justify-end gap-1">
                         <button onClick={() => handleSave(item.id)} className="text-green-600 hover:text-green-700 p-1 hover:bg-green-50 rounded">
                         ...
                         <button onClick={() => setEditingId(null)} className="text-red-500 hover:text-red-600 p-1 hover:bg-red-50 rounded">
                       ...
                       <button 
                         ...
                         className="text-muted-foreground hover:text-primary opacity-0 group-hover:opacity-100 transition-opacity p-1 hover:bg-muted rounded"
                         title="Editar"
                       >
